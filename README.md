# LumynaX OCR TrOCR Large Printed

> 🇳🇿 **Made in Aotearoa New Zealand** by **AbteeX AI Labs** — part of the **LumynaX** sovereign-AI release family.

[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-ocr-trocr-large-printed) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-ocr-trocr-large-printed` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-ocr-trocr-large-printed --local-dir lumynax-ocr-trocr-large-printed
cd lumynax-ocr-trocr-large-printed && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-ocr-trocr-large-printed -i
```
...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX OCR TrOCR Large Printed release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX OCR TrOCR Large Printed</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: trocr" src="https://img.shields.io/badge/Family-trocr-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text+vision" src="https://img.shields.io/badge/Modes-text+vision-4d6b44?style=for-the-badge" />  <img alt="Params: 0.55B" src="https://img.shields.io/badge/Params-0.55B-0a0a0b?style=for-the-badge" />  <img alt="Quant: fp32 safetensors" src="https://img.shields.io/badge/Quant-fp32%20safetensors-111827?style=for-the-badge" />  <img alt="Context: 512%20tok" src="https://img.shields.io/badge/Context-512%20tok-111827?style=for-the-badge" />  <img alt="License: mit" src="https://img.shields.io/badge/License-mit-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>4/5</b></kbd> &middot; <kbd>Lightweight: <b>4/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>no</b></kbd> &middot; <kbd>Context: <b>512 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-ocr-trocr-large-printed` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-ocr-trocr-large-printed --local-dir lumynax-ocr-trocr-large-printed
cd lumynax-ocr-trocr-large-printed
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-ocr-trocr-large-printed", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-ocr-trocr-large-printed", device_map="auto", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX OCR TrOCR Large Printed` |
| Repository | `AbteeXAILab/lumynax-ocr-trocr-large-printed` |
| Family | `trocr` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `microsoft/trocr-large-printed` |
| Source | `Microsoft TrOCR` |
| License | `mit` |
...
```text
You are LumynaX operating from the LumynaX OCR TrOCR Large Printed package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
